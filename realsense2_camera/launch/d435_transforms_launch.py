...
def launch_setup(context, *args, **kwargs):
    ...
    cam_in_hand_transform_pub = Node(
            ...
            # arguments=['0.4', '0.56', '0.155', '-1.0', '0.0', '0.0', '1.0', 'base_link', 'camera_color_optical_frame'], #Adjusted roll
            # arguments=['0.4', '0.56', '0.155', '-0.5', '0.5', '-0.5', '0.5', 'base_link', 'camera_color_optical_frame'], #Adjusted roll
