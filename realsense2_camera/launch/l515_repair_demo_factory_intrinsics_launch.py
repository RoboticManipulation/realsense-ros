...
#json_path = os.path.join(get_package_share_directory('realsense2_camera'), 'config', 'l515_high_accuracy.json')
...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_module.profile',         'default': '1024x768x30', 'description': 'depth module profile'},                          
