...
json_path = os.path.join(get_package_share_directory('realsense2_camera'), 'config', 'd405_high_accuracy.json')
...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_module.profile',         'default': '1280x720x30', 'description': 'depth module profile'},                          
                        ...
                        #    {'name': 'ordered_pc',                   'default': 'true', 'description': ''},
                           ...
                           {'name': 'publish_tf',            'default': 'true', 'description': 'Publishes tfs when true'},
